                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            ?>
                                <tr>
                                    <td><?php echo $stock['id']; ?> <a href="del-watchlist-stock.php?stockid=<?php echo $stock['id']; ?>&watchlistid=<?php echo $_GET['id']; ?>"></a></td>
                                    <td><?php echo $stock['symbol']; ?></a><br><small><?php echo $stock['name']; ?></small>
                                    </td>
                                    <!-- <td>Otto</td>
