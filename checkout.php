            ...
            <div class="row">
                ...
                <div class="col-md-4 order-md-2 mb-4">
                    <h4 class="d-flex justify-content-between align-items-center mb-3">
                        <span class="text-muted">ORDER BOOK</span>
                    ...
                    <a href="index.php" class="btn btn-block btn-info">ADD STOCKS</a>
                </div>
                <div class="col-md-8 order-md-1">
                    ...
                    <form method="post" action="cartAction.php">
                        ...
                        <input class="btn btn-success btn-lg btn-block" onSubmit="" type="submit" name="checkoutSubmit" value="Place Order">
                        </div>
                    </form>
                </div>
            </div>
